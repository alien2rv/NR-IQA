...
from expertIQA import blur_VGG,image_split,awgn_VGG,jpeg_VGG,jp2k_VGG
...
res = dtc_VG()
res.summary()
plot_model(res, to_file='D:\\thesis\\coding\\deepnets\\dtc.png', show_shapes = True)
res.fit(X_train, Y_train[:,:4], validation_data=(X_valid, Y_valid[:,:4]),
                          epochs=20,verbose=1)
pred_dtc = res.predict(X_test)
res.save_weights("D:\\thesis\\coding\\deepnets\\DTC.h5")
np.save("D:\\thesis\\coding\\deepnets\\DTC.npy",pred_dtc,  allow_pickle=True, fix_imports=True)
...
res = blur_VGG()
res.summary()
plot_model(res, to_file='D:\\thesis\\coding\\deepnets\\gblur.png', show_shapes = True)
res.fit(X_train, (Y_train[:,:1]*0.01), validation_data=(X_valid, (Y_valid[:,:1]*0.01)),
                          epochs=20,verbose=1)
res.save_weights("D:\\thesis\\coding\\deepnets\\gblur.h5")
...
res = awgn_VGG()
res.summary()
plot_model(res, to_file='D:\\thesis\\coding\\deepnets\\awgn.png', show_shapes = True)
res.fit(X_train, (Y_train[:,:1]*0.01), validation_data=(X_valid, (Y_valid[:,:1]*0.01)),
                          epochs=20,verbose=1)
res.save_weights("D:\\thesis\\coding\\deepnets\\awgn.h5")
...
res = jpeg_VGG()
res.summary()
plot_model(res, to_file='D:\\thesis\\coding\\deepnets\\jpeg.png', show_shapes = True)
res.fit(X_train, (Y_train[:,:1]*0.01), validation_data=(X_valid, (Y_valid[:,:1]*0.01)),
                          epochs=20,verbose=1)
res.save_weights("D:\\thesis\\coding\\deepnets\\jpeg.h5")
...
res = jp2k_VGG()
res.summary()
plot_model(res, to_file='D:\\thesis\\coding\\deepnets\\jp2k.png', show_shapes = True)
res.fit(X_train, (Y_train[:,:1]*0.01), validation_data=(X_valid, (Y_valid[:,:1]*0.01)),
                          epochs=20,verbose=1)
res.save_weights("D:\\thesis\\coding\\deepnets\\jp2k.h5")