...
#blur
model_blur = blur_VGG("D:\\thesis\\coding\\deepnets\\gblur.h5")
pred_blur = model_blur.predict(X_test)

# awgn
model_awgn = awgn_VGG("D:\\thesis\\coding\\deepnets\\awgn.h5")
pred_awgn = model_awgn.predict(X_test)

# jpeg
model_jpeg = jpeg_VGG("D:\\thesis\\coding\\deepnets\\jpeg.h5")
pred_jpeg = model_jpeg.predict(X_test)

# jpeg
model_jp2k = jp2k_VGG("D:\\thesis\\coding\\deepnets\\jp2k.h5")
pred_jp2k = model_jp2k.predict(X_test)

DT = dtc_VG("D:\\thesis\\coding\\deepnets\\DTC.h5")
...
layer_outputs = [layer.output for layer in model_jp2k.layers] 
layer_outputs = layer_outputs[1:] 
activation_model = Model(inputs=model_jp2k.input, outputs=layer_outputs)
